...
export default function LandingPage() {
  ...
  return (
    <div className="bg-[#FAF7F2] text-[#111111] min-h-screen overflow-x-hidden font-sans selection:bg-[#E5A93C]/20 selection:text-[#E5A93C]">
      ...
      >
        <div className="pointer-events-auto flex items-center gap-3">
          <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-[#E5A93C] to-[#D96B43] flex items-center justify-center shadow-lg shadow-[#D9CFC1] border border-[#D9CFC1]">
        ...
        <nav className="hidden md:flex items-center gap-10 pointer-events-auto font-mono text-xs uppercase tracking-widest text-[#333333]">
          <a href="#about" onClick={(e) => { e.preventDefault(); document.getElementById('about')?.scrollIntoView({ behavior: 'smooth' }); }} className="hover:text-[#111111] transition-colors hover:shadow-[0_2px_0_rgba(229,169,60,0.5)] cursor-pointer">MANIFESTO</a>
        ...
        <div className="pointer-events-auto">
          <Link href="/dashboard">
            <button className="relative group px-5 py-2.5 rounded-xl bg-[#FAF7F2] border border-[#D9CFC1] hover:border-[#E5A93C] transition-all duration-300 font-mono text-xs uppercase tracking-widest text-[#111111] overflow-hidden backdrop-blur-sm cursor-pointer">
      ...
      >
        ...
        <div className="max-w-4xl relative z-10">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#FAF7F2]/5 border border-[#D9CFC1] text-[10px] font-mono tracking-widest text-[#E5A93C] mb-6 uppercase">
          ...
          <div className="hero-sub mt-10 flex flex-wrap gap-4">
            <Link href="/dashboard">
              <button className="px-8 py-4 rounded-xl bg-[#E5A93C] text-[#111111] font-extrabold text-xs tracking-widest uppercase hover:bg-[#FAF7F2] hover:text-[#111111] transition-colors duration-300 shadow-xl shadow-[#D9CFC1] flex items-center gap-3 cursor-pointer">
      ...
      <section 
        id="about"
        ref={aboutRef}
        className="relative py-36 px-6 md:px-24 bg-[#F2EFE9] border-b border-[#D9CFC1] overflow-hidden flex flex-col justify-center min-h-[85vh]"
      >
        ...
        <div className="sectors-stack relative w-full flex flex-col">
          ...
          <section className="sector-card sticky top-0 w-full h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-white border-b border-[#D9CFC1] relative overflow-hidden">
            ...
            <div className="max-w-6xl w-full mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative h-80 lg:h-[26rem] rounded-2xl border border-[#10B981]/20 bg-[#FAF7F2] overflow-hidden flex flex-col justify-between p-8 group shadow-2xl shadow-[#D9CFC1]/40">
          ...
          <section className="sector-card sticky top-0 w-full h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-white border-b border-[#D9CFC1] relative overflow-hidden">
            ...
            <div className="max-w-6xl w-full mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative h-80 lg:h-[26rem] rounded-2xl border border-[#F59E0B]/20 bg-[#FAF7F2] overflow-hidden flex flex-col justify-between p-8 shadow-2xl shadow-[#D9CFC1]/40">
          ...
          <section className="sector-card sticky top-0 w-full h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-white border-b border-[#D9CFC1] relative overflow-hidden">
            ...
            <div className="max-w-6xl w-full mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative h-80 lg:h-[26rem] rounded-2xl border border-[#8B5CF6]/20 bg-[#FAF7F2] overflow-hidden flex flex-col justify-between p-8 shadow-2xl shadow-[#D9CFC1]/40">
      ...
      >
        ...
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* Metric 1 */}
            <div className="grid-card p-8 rounded-2xl bg-[#FAF7F2]/[0.02] border border-[#D9CFC1] hover:border-[#E5A93C]/40 hover:bg-[#FAF7F2]/[0.04] transition-all duration-300 flex flex-col justify-between h-80 relative overflow-hidden group">
            ...
            {/* Metric 2 */}
            <div className="grid-card p-8 rounded-2xl bg-[#FAF7F2]/[0.02] border border-[#D9CFC1] hover:border-[#10B981]/40 hover:bg-[#FAF7F2]/[0.04] transition-all duration-300 flex flex-col justify-between h-80 relative overflow-hidden group">
            ...
            {/* Metric 3 */}
            <div className="grid-card p-8 rounded-2xl bg-[#FAF7F2]/[0.02] border border-[#D9CFC1] hover:border-[#8B5CF6]/40 hover:bg-[#FAF7F2]/[0.04] transition-all duration-300 flex flex-col justify-between h-80 relative overflow-hidden group">
        ...
        <div className="max-w-3xl relative z-10 flex flex-col items-center space-y-6">
          ...
          <Link href="/dashboard" className="relative mt-8 block pointer-events-auto">
            <button 
              ...
              className="relative px-10 py-5 bg-[#E5A93C] text-[#111111] font-extrabold text-xs tracking-widest uppercase rounded-xl hover:bg-[#FAF7F2] transition-colors duration-300 shadow-2xl shadow-[#D9CFC1]/40 shadow-gray-300 overflow-hidden cursor-pointer"
            >
              <motion.div
